...
config :sprint_lens, SprintLensWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "gBAT0yTdsgW4XQ7KX+BWmSwgmuGJtIrRdA0rxCNZCjQZUKNbWk8Fb5XAgMHJAbcb",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:sprint_lens, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:sprint_lens, ~w(--watch)]}
  ]
